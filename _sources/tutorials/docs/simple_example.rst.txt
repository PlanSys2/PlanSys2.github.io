...
In this tutorial we are going to analyze the package of the simple example shown in: ref: `getting_started`.
...
The actions in the domain are *move*, *charge* and *ask_charge*. It will contains a "fake" execution. Each action will take some seconds
